  ...
  <div class="row">
    <div class="col-md-12">
      <div class="ibox-content">
        ...
        <p>For the process on how to use & submit the forms below, Please see section 2 for procurement of the <a href="https://drive.google.com/open?id=1xBRaLi2WXXECybvkZwVQdo0uR94n2AiWWbxHeYbgUh0" target="_blank">operations
            manual</a></p>
        <div class="row">
          <div class="col-md-4">
            <div class="ibox-content">
            ...
            <div class="ibox-content">
              <a href="https://drive.google.com/drive/folders/1tnXcBv8L0UcAGY64zSFOCj9VGy61n1ig?usp=sharing" target="_blank">
                <div class="widget yellow-bg p-lg text-center" style="margin-top: 0px;">
                  <div class="m-b-md">
                    <i class="fa fa-file-text-o fa-3x"></i>
                    <h3 class="m-xs">Procurement Request Forms</h3>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div class="ibox-content">
              <a href="https://drive.google.com/drive/folders/1RO4Xzm7mwFOeX0oqHy0EHvhH_3f0C3e2?usp=sharing" target="_blank">
                <div class="widget yellow-bg p-lg text-center" style="margin-top: 0px;">
                  <div class="m-b-md">
                    <i class="fa fa-file-text-o fa-3x"></i>
                    <h3 class="m-xs">Delegation of Authority</h3>
                  </div>
                </div>
              </a>
            </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="ibox-content">
        ...
        <p>For the process on how to use & submit the forms below, Please see section 1 for funds advance of the <a href="https://drive.google.com/open?id=1xBRaLi2WXXECybvkZwVQdo0uR94n2AiWWbxHeYbgUh0" target="_blank">operations
            manual</a></p>
        <div class="row">
          <div class="col-md-4">
            <div class="ibox-content">

                  ...
                  @foreach ($distributions as $key => $value)
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="submit" value="Delete"class="btn btn-primary btn-xs js-submit-confirm data" data-confirm-message="You will be delete distribution target {{strtolower($value->name)}}" {{count($value->projects) > 0 ? 'disabled' : ''}} >

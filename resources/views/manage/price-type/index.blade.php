                  ...
                  @foreach ($datas as $key => $value)
                    <tr>
                      ...
                      <td>
                        ...
                        <input type="submit" value="Delete"class="btn btn-primary btn-xs js-submit-confirm data" data-confirm-message="You will be delete price type {{strtolower($value->name)}}">
                        </form>
                      </td>
                    </tr>
                  @endforeach

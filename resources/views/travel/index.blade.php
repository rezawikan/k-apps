  ...
  <div class="row">
    <div class="col-md-12">
      <div class="ibox-content">
        ...
        {{-- <p>For the process on how to use & submit the forms below, Please see section 1 for funds advance and 2 for procurment of the <a href="https://docs.google.com/document/d/1d3warAg9UHyielvPV5nCv1ENDGA1v7y3O06VaWnCgf8/edit?usp=sharing">operations manual</a></p>
        --}}
        <div class="row">
          <div class="col-md-4">
            <div class="ibox-content">
              <a href="https://drive.google.com/drive/folders/1KpPOA4TGQ93onpe6St-qV7h4G3DbP1rR?usp=sharing" target="_blank">
                <div class="widget yellow-bg p-lg text-center" style="margin-top: 0px;">
                  <div class="m-b-md">
                    <i class="fa fa-file fa-3x"></i>
                    <h3 class="m-xs">Travel Advance Forms</h3>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div class="ibox-content">
              <a href="https://drive.google.com/drive/folders/1KsAjfqMAWIg3v6u21gAJt8u_hwqTI1sH?usp=sharing" target="_blank">
                <div class="widget navy-bg p-lg text-center" style="margin-top: 0px;">
                  <div class="m-b-md">
                    <i class="fa fa-copy fa-3x"></i>
                    <h3 class="m-xs">Travel Advance Reconciliation Forms</h3>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div class="ibox-content">
              <a href="https://drive.google.com/drive/folders/1Kzn21wrJVpeLH9uJwsvX6QwKCWpA1kN7?usp=sharing" target="_blank">
                <div class="widget blue-bg p-lg text-center" style="margin-top: 0px;">
                  <div class="m-b-md">
                    <i class="fa fa-plane fa-3x"></i>
                    <h3 class="m-xs">Flight Quotation Forms</h3>
                  </div>
                </div>
              </a>
            </div>
          ...
          <div class="col-md-6">
            <div class="ibox-content">
              ...
              <ul class="todo-list m-t small-list">
                ...
                <li><span class="m-l-xs">Send completed Flight Quotation Form to two travel agents: Bali Joy (balijoy@indo.net.id)/>/> and Antavaya (ccc.dps<blade antavaya.com) and cc: Budget holder & Kopernik Travel (travel<blade kopernik.info) </span>

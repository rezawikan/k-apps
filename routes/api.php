...
Route::get('project-technology/{idp}/{idt}/list', 'Api\ProjectTechnologyController@edit')->name('project-technology.edit');
Route::put('project-technology/{idp}/{idt}/update', 'Api\ProjectTechnologyController@update')->name('project-technology.update');
